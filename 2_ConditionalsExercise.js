...
function exercise4(varA, varB) {
  ...
  if(varA === varB){
    ...
    answer4 = "varA and varB are differ";
  }
...
/* Even if both variable have the same value but variable varA a is string ("3") and varB is a number (3) 
it would not pass the tests, because I'm using strict equality === so both variable has to have the same value and 
data type.
*/
...
function exercise8(amount1, amount2, minimum, maximum) {
  ...
  // Write your code for the exercise below here:
  // --------------------------------------------
  if((minimum < amount1 && amount1< maximum ) && 
  (minimum < amount2 && amount2< maximum)){
    answer8 = true;
  }
  else{
    answer8 = false;
...
console.log(exercise8(4, 8,4,10));
...
//For me it wasn't hard or easy, it was just okay
/*
I use google when I was working with the switch statement because after writing my switch statements, 
it keep displaying the default answer, google show me that I forgot to put break; after each case
*/
